...
export class LoadingTest extends Observable {
  ...
  public showLoaderDimBg() {
    this.indicator.show({ios: {dimBackground: true}, android: {dimBackground: true}});
    this.demoLoader();
  }
  ...
  public showLoaderDeterminate() {
    this.indicator.show({ios: {mode: MBProgressHUDMode.Determinate}, mode: Mode.Determinate});
    this.demoProgress();
  }

  public showLoaderAnnularDeterminate() {
    this.indicator.show({
      ios: {mode: MBProgressHUDMode.AnnularDeterminate, color: '#fff', backgroundColor: '#4B9ED6'},
  ...
  public showLoaderDeterminateHorizontalBar() {
    this.indicator.show({
      ios: {mode: MBProgressHUDMode.DeterminateHorizontalBar, color: 'red', backgroundColor: 'white'},
  ...
  public showLoaderCancel() {
    let interval;
    this.indicator.show({
      ios: {mode: MBProgressHUDMode.Determinate}, mode: Mode.Determinate,
      android: {
        cancelable: true,
